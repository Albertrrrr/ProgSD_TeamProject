...
class StationManagementPage():
    ...
    def CreatePage(self):
        ...
        del_enter_btn = Button(self.page, command=self.addBike, text="Enter", bg='#4CAF50', fg='white',
                               font=("Arial", 10))
        del_enter_btn.place(x=250, y=390)
        del_clear_btn = Button(self.page, text="Clear", command=self.clear_1, bg='#4CAF50', fg='white',
                               font=("Arial", 10))
        ...
        battery_enter_btn = Button(self.page, command=self.delete, text="Enter", bg='#4CAF50', fg='white',
                                   font=("Arial", 10))
        battery_enter_btn.place(x=250, y=550)
        battery_clear_btn = Button(self.page, command=self.clear_2, text="Clear", bg='#4CAF50', fg='white',
                                   font=("Arial", 10))
        ...
        move_enter_btn = Button(self.page, command=self.addStation, text="Enter", bg='#4CAF50', fg='white',
                                font=("Arial", 10))
        move_enter_btn.place(x=600, y=390)
        move_clear_btn = Button(self.page, command=self.clear_3, text="Clear", bg='#4CAF50', fg='white',
                                font=("Arial", 10))
