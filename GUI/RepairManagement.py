...
class RepairManagementPage():
    ...
    def CreatePage(self):
        ...
        # Start Fix
        del_lbl = Label(self.page, text="Start repair:", bg='white', font=("Arial", 12))
        del_lbl.place(x=50, y=350)
        del_entry_lbl = Label(self.page, text="bikeID", bg='white', font=("Arial", 10))
        del_entry_lbl.place(x=50, y=390)
        self.__repairID = Entry(self.page, width=20)
        self.__repairID.place(x=85, y=390)
        ...
        move_lbl = Label(self.page, text="Over repair:", bg='white', font=("Arial", 12))
        move_lbl.place(x=400, y=350)
        move_entry_lbl = Label(self.page, text="bikeID", bg='white', font=("Arial", 10))
        move_entry_lbl.place(x=392, y=390)
        self.__overRepairBike = Entry(self.page, width=20)
        self.__overRepairBike.place(x=435, y=390)
        move_entry_lbl = Label(self.page, text="reportID", bg='white', font=("Arial", 10))
        move_entry_lbl.place(x=392, y=420)
        self.__overRepairID = Entry(self.page, width=20)
        self.__overRepairID.place(x=435, y=420)
        ...
        self.__info_list_2 = scrolledtext.ScrolledText(self.page, width=130, height=5)
        self.__info_list_2.place(x=50, y=460)
