...
root.title("View all stations")

# Top frame
top_frame = tk.Frame(root, bg="#4682B4")
top_frame.grid(row=0, column=0, sticky='ew', padx=20, pady=10, columnspan=4)

tk.Label(top_frame, text="View all stations", font=("Arial", 14, "bold"), bg="#4682B4", width=20, height=2).grid(row=0, column=0, padx=5, pady=5)
